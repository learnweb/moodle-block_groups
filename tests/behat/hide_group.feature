...
Feature: Hide a group in a group block
  ...
  Scenario: Students do not see group when it is hidden again
    ...
    Then I should see "Group 1" in the "//div[@class='wrapperblockgroupsandgroupingcheckbox']['checkboxgroup']" "xpath_element"
    ...
    And I follow "Course 1"
    Then I should not see "Group 1" in the "//div[@class='wrapperblockgroupsandgroupingcheckbox']['checkboxgroup']" "xpath_element"
    Then I should see "Group 2" in the "//div[@class='wrapperblockgroupsandgroupingcheckbox']['checkboxgroup']" "xpath_element"
    And I log out
